...
mongoose.connect('mongodb+srv://shobhit:shobhit@cluster0.gvj33.mongodb.net/reception-db')
.then(()=>{
...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid="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";
  ...
  const msg={
      to: email,
      from: "sonal1184.cse19@chitkara.edu.in",
